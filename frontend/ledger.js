...
async function loadTransactions() {
    ...
    try {
        ...
        const response = await fetch(
            `http://localhost:8081/api/transactions/customer/${customerId}`
        );
...
editForm.addEventListener(
    ...
    async function (event) {
        ...
        try {
            ...
            const response =
                await fetch(
                    `http://localhost:8081/api/transactions/${editingTransactionId}`,
                    {
                        method: "PUT",
...
async function deleteTransaction(id) {
    ...
    try {
        ...
        const response =
            await fetch(
                `http://localhost:8081/api/transactions/${id}`,
                {
                    method: "DELETE"
                }
            );
